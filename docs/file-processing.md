...
3. Envia o arquivo compactado para o servidor, permitindo arquivos de até 30MB após a compactação
...
4. **Limite de tamanho após compactação**: Se o arquivo compactado for maior que 30MB, será exibido um erro
...
2. Se o arquivo for maior que o limite (10MB), ele é processado automaticamente:
   ...
   - Se o arquivo compactado for maior que 30MB, um erro é exibido
...
- **Tamanho máximo para arquivos compactados**: 30MB
...
- Se um arquivo continuar muito grande mesmo após a compactação (>30MB), não será possível enviá-lo
